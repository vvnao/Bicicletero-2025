...
import fondoFuncionario from '../assets/fondo-funcionario.png';
import { User, Mail, Phone, IdCard, Lock, Eye, EyeOff, Bike, ArrowLeft, Briefcase, Users, Clipboard } from "lucide-react";
...
export default function RegisterAssistant() {
  ...
  const styles = {
    ...
    registerContainerAssistant: {
      position: 'absolute', zIndex: 2, width: '90%', maxWidth: '800px',
      minWidth: '320px', padding: '2.5rem', background: 'rgba(13, 25, 40, 0.85)',
      borderRadius: '18px', backdropFilter: 'blur(4px)',
      boxShadow: '0 4px 6px rgba(0, 0, 0, 0.1)', left: '5%', top: '50%',
      transform: 'translateY(-50%)', maxHeight: '95vh', height: 'auto',
      overflowY: 'scroll'
    },
    formInputPositionDescription: {
      width: '100%', padding: '14px 14px 14px 45px', background: '#cadbfe',
      fontFamily: "'Nunito', sans-serif", fontSize: '18px', fontWeight: 600,
      color: '#0d1928', border: 'none', borderRadius: '14px', outline: 'none',
      transition: '0.3s ease', height: '120px', resize: 'vertical'
    },
    inputWrapperPositionDescription: {
      display: 'flex', alignItems: 'flex-start', position: 'relative', width: '100%'
    },
    inputIconPositionDescription: {
      position: 'absolute', left: '14px', top: '12px',
      color: '#3e4856', pointerEvents: 'none'
    },
    registerAssistantPositionSection: {
      marginTop: '2rem', borderTop: '2px solid white', paddingTop: '1rem'
    },
    registerAssistantPositionTitle: {
      fontFamily: "'Poppins', sans-serif", fontSize: '26px', fontWeight: 700,
      color: 'white', textAlign: 'left', marginBottom: '1rem',
  ...
  return (
    <>
      ...
      <div style={{ ...styles.registerBackground, backgroundImage: `url(${fondoFuncionario})` }}></div>
      <div style={styles.registerContainerAssistant}>
        ...
        <form onSubmit={handleSubmit}>
          ...
          <div style={styles.formGroup}>
            ...
            <div style={styles.inputWrapperPass}> {/* Cambiado a inputWrapperPass */}
          ...
          <div style={styles.registerAssistantPositionSection}>
            <h3 style={styles.registerAssistantPositionTitle}>
              INFORMACIÓN DEL CARGO
            </h3>

            <div style={styles.formGroup}>
              <label style={styles.formLabel}>NOMBRE DEL CARGO</label>
              <div style={styles.inputWrapper}>
                <Briefcase size={20} color={colorIcono} style={styles.inputIcon} />
                <input
                  name='position'
            ...
            <div style={styles.formGroup}>
              <label style={styles.formLabel}>DESCRIPCIÓN DEL CARGO</label>
              <div style={styles.inputWrapperPositionDescription}>
                <Users size={20} color={colorIcono} style={styles.inputIconPositionDescription} />
                <textarea
                  name='positionDescription'
                  placeholder='Descripción del cargo...'
                  onChange={handleChange}
                  style={styles.formInputPositionDescription}
                  required
                />
              </div>
            </div>
