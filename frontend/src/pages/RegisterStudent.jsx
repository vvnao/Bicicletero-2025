...
export default function RegisterStudent() {
    ...
    const [photo, setPhoto] = useState(null); // foto de la bicicleta
    ...
    return (
        <form onSubmit={handleSubmit} className="max-w-md mx-auto p-4 bg-white rounded shadow">
            <h2 className="text-xl mb-3">Registro — Estudiante</h2>
            ...
            <label className="block mb-1">Foto TNE (requerida para estudiantes)</label>
            <input type="file" name="tnePhoto" accept="image/*" onChange={handleFileChange} className="mb-2" required />
